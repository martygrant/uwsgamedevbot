...
class GameDevDictionary(commands.Cog):
    ...
    @commands.command(pass_context=True, name='D.General')
    ...
    @commands.command(pass_context=True, name='D.unity')
    ...
    @commands.command(pass_context=True, name='D.Unreal')
    ...
    @commands.command(pass_context=True, name='D.Godot')
    ...
    @commands.command(pass_context=True, name='D.Art')
    ...
    @commands.command(pass_context=True, name='D.Programming')
    ...
    @commands.command(pass_context=True, name='D.Audio')
    ...
    @commands.command(pass_context=True, name='D.Shaders')
